...
<html lang="en"> 
    ...
    <body>
        ...
        <div class="hold">
            <img src="<?php echo base_url(); ?>/images/mycake.jpg" alt="">
            <div class="loginpanelhold">
                <div id="logpage" class="subphold" >
                    <div class="l-text loginpanel v-align" style="font-size: 20px;">Welcome to the cake store</div>
                    <div class="loginpanel">
                        ...
                        <div class="buttonpack">
                            ...
                            <div id="loginacct" class="login v-align">Login!</div>                        
                        </div>
                    </div>
                </div>
            </div>
